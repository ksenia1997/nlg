...
class GPT2Model(object):
    def __init__(self):
        ...
        self.combine = 50000 # Concatenate input files with <|endoftext|> separator into chunks of this minimum size
        #self.dataset_path = "./gpt/src/checkpoint/run1/encoded.npz"
